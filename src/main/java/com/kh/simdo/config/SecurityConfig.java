...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http.authorizeRequests()
                .mvcMatchers(HttpMethod.GET, "/index","/user/login", "/user/join", "/user/joinimpl/**","/user/idcheck","/about","/blog","/blog-single","/contact","/movie/movielist","/movie/db").permitAll() //이경로들은 권한관리안하고도 쓸 수 있게
